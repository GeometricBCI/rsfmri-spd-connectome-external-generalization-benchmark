...
# ---------------------------------------------------------------------
# Ridge TangentSpace (fast: TS fit once per outer fold)
# ---------------------------------------------------------------------
...
def args_parser():
    ...
    p.add_argument("--ridge_n_jobs", type=int, default=1)  # IMPORTANT: avoid oversubscription hang
    p.add_argument("--ridge_alphas", type=float, nargs="+", default=[1e-2, 1e-1, 1.0, 10.0, 100.0, 1e3])
